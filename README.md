...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lively-truth-189f)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lively-truth-189f
```

A live public deployment of this template is available at [https://lively-truth-189f.templates.workers.dev](https://lively-truth-189f.templates.workers.dev)
